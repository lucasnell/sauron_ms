...
%            + \\ & \hspace*{4em} \sigma_{\varepsilon_{v_1}}^2 v_1 \alpha_0 \Omega \text{e}^{-v_1^2 - v_2^2} (1 - 8 v_1^2) + \sigma_{\varepsilon_{v_1}}^2 v_1 f
%            - \\ & \hspace*{4em} \sigma_{\varepsilon_{v_2}}^2 4 \alpha_0 \Omega v_1 v_2^2 \text{e}^{-v_1^2 - v_2^2} (1 - v_2^2) - \sigma_{\varepsilon_{v_2}}^2 f \eta v_2^2
%        \Big] \\[2ex]
%
%
\text{.}
...
%     Additive genetic variance ($\sigma_A^2$) was fixed at 0.05 for 
%     these simulations.}
